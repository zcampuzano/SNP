...
- (void)setConfig:(NSDictionary *)config
{
   ...
   SCVideoOverlay *_videoOverlay = [SCVideoOverlay updateWithVideoTime];
...
- (SCVideoOverlay*)createOverlay
{
  SCVideoOverlay *overlay = [SCVideoOverlay emptyOverlay];
...
- (void)save:(void(^)(NSError *error, NSURL *outputUrl))callback
{
   ...
   assetExportSession.videoConfiguration.overlay = [self updateWithVideoTime:1000];
